                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="card-text">For custom Bootstrap form validation messages, you’ll need to
                                        add the <code>novalidate</code> boolean attribute to your form. For server side
                                        validation <router-link
                                            to="https://getbootstrap.com/docs/4.1/components/forms/#server-side"
                                            target="_blank">read full documentation</router-link>.</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="card-text">Not interested in custom validation feedback messages or
                                        writing JavaScript to change form behaviors? All good, you can use the browser
                                        defaults. Try submitting the form below.</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="card-text">We recommend using client side validation, but in case you
                                        require server side, you can indicate invalid and valid form fields with
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="card-text">Form validation styles are also available for bootstrap custom
                                        form controls.</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm">
                                            <form class="was-validated">
                                                ...
                                                <div class="custom-control custom-radio mb-3">
                                                    ...
                                                    <label class="custom-control-label"
                                                        for="customControlValidation3">Or toggle this other custom
                                                        radio</label>
                            ...
                            <div class="card mb-0">
                                <div class="card-header">
                                    ...
                                    <p class="card-text">You can swap the <code>.{valid|invalid}-feedback</code> classes
                                        for <code>.{valid|invalid}-tooltip</code> classes to display validation feedback
