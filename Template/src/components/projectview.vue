                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-right ml-auto">
                                ...
                                <router-link to="/taskboard" class="btn btn-white float-right m-r-10"
                                    data-toggle="tooltip" title="Task Board"><i class="fa fa-bars"></i></router-link>
                            </div>
                        </div>
                    </div>
                    <!-- /Page Header -->
                                ...
                                <div class="card-body">
                                    <div class="project-title">
                                        ...
                                        <small class="block text-ellipsis m-b-15"><span class="text-xs">2</span> <span
                                                class="text-muted">open tasks, </span><span class="text-xs">5</span>
                                            ...
                                            <div class="files-cont">
                                                ...
                                                <div class="files-info">
                                                    <span class="file-name text-ellipsis"><a href="#">AHA Selfcare
                                                            Mobile Application Test-Cases.xls</a></span>
                                    ...
                                    <table class="table table-striped table-border">
                                        <tbody>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <a href="#" class="badge badge-danger dropdown-toggle"
                                                            data-toggle="dropdown">Highest </a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <tr>
                                                <td>Created by:</td>
                                                <td class="text-right">
                                                    <router-link to="/profile">Barry Cuda</router-link>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Status:</td>
                                                ...
                                                <div class="list-item">
                                                    <div class="list-left">
                                                        <span class="avatar"><img alt=""
                                                                src="../assets/profiles/avatar-11.jpg"></span>
                                                    </div>
                                                    <div class="list-body">
                                        ...
                                        <li>
                                            <router-link to="/profile">
                                                <div class="list-item">
                                                    <div class="list-left">
                                                        <span class="avatar"><img alt=""
                                                                src="../assets/profiles/avatar-01.jpg"></span>
                                                    </div>
                                                    <div class="list-body">
                                ...
                                <div class="card-body">
                                    <h6 class="card-title m-b-20">
                                        ...
                                        <button type="button" class="float-right btn btn-primary btn-sm"
                                            data-toggle="modal" data-target="#assign_user"><i class="fa fa-plus"></i>
                                            Add</button>
                                    </h6>
                                    <ul class="list-box">
                                        <li>
                                            <router-link to="/profile">
                                                <div class="list-item">
                                                    <div class="list-left">
                                                        <span class="avatar"><img alt=""
                                                                src="../assets/profiles/avatar-02.jpg"></span>
                                                    </div>
                                                    <div class="list-body">
