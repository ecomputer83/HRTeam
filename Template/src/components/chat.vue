                                    ...
                                    <div class="navbar">
                                        <div class="user-details mr-auto">
                                            ...
                                            <div class="user-info float-left">
                                                <router-link to="/profile" title="Mike Litorus"><span>Mike
                                                        Litorus</span> <i class="typing-text">Typing...</i>
                                                </router-link>
                                        ...
                                        <ul class="nav custom-menu">
                                            <li class="nav-item">
                                                <a class="nav-link task-chat profile-rightbar float-right"
                                                    id="task_chat" href="#task_window"><i class="fa fa-user"></i></a>
                                            </li>
                                            <li class="nav-item">
                                                <router-link to="/voicecall" class="nav-link"><i
                                                        class="fa fa-phone"></i></router-link>
                                            </li>
                                            <li class="nav-item">
                                                <router-link to="/videocall" class="nav-link"><i
                                                        class="fa fa-video-camera"></i></router-link>
                                            </li>
                                    ...
                                    <div class="message-bar">
                                        <div class="message-inner">
                                            <a class="link attach-icon" href="#" data-toggle="modal"
                                                data-target="#drag_files"><img src="../assets/attachment.png"
                                                    alt=""></a>
