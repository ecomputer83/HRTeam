                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-right ml-auto">
                                <router-link to="/createestimate" class="btn add-btn"><i class="fa fa-plus"></i>Create
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped custom-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <router-link to="/estimateview">EST-0001</router-link>
                                            </td>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <router-link to="/editestimate" class="dropdown-item"><i
                                                                class="fa fa-pencil m-r-5"></i> Edit</router-link>
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                            data-target="#delete_estimate"><i
                                        ...
                                        <tr>
                                            <td>
                                                <router-link to="/estimateview">EST-0002</router-link>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <router-link to="/estimateview">EST-0003</router-link>
                                            </td>
                                            <td>Cream Inc</td>
                                            <td>11 Mar 2019</td>
                                            <td>17 Mar 2019</td>
                                        ...
                                        <tr>
                                            <td>
                                                <router-link to="/editestimate">EST-0004</router-link>
                                            </td>
