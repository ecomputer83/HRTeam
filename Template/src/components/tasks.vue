								...
								<div class="fixed-header">
									<div class="navbar">
										...
										<a class="task-chat profile-rightbar float-right" id="task_chat"
											href="#task_window"><i class="fa fa fa-comment"></i></a>
											...
											<div class="chat-box">
												<div class="chats">
													...
													<div class="task-information">
														<span class="task-info-line"><a class="task-user"
																href="#">Lesley Grauer</a> <span
																class="task-info-subject">added to Hospital
													...
													<div class="task-information">
														<span class="task-info-line"><a class="task-user"
																href="#">Lesley Grauer</a> <span
																class="task-info-subject">assigned to John
																Doe</span></span>
														<div class="task-time">Jan 20, 2019</div>
													</div>
													<hr class="task-line">
													<div class="task-information">
														<span class="task-info-line"><a class="task-user" href="#">John
																Doe</a> <span class="task-info-subject">changed the due
																date to Sep 28</span> </span>
								...
								<div class="chat-footer">
									<div class="message-bar">
										<div class="message-inner">
											<a class="link attach-icon" href="#"><img src="../assets/attachment.png"
													alt=""></a>
									...
									<div class="project-members task-followers">
										...
										<a href="#" class="followers-add" data-toggle="modal"
									...
									<ul class="chat-user-list">
										...
										<li>
											<a href="#">
												<div class="media">
													<span class="avatar"><img alt=""
															src="../assets/profiles/avatar-08.jpg"></span>
													<div class="media-body media-middle text-nowrap">
										...
										<li>
											<a href="#">
												<div class="media">
													<span class="avatar"><img alt=""
															src="../assets/profiles/avatar-26.jpg"></span>
													<div class="media-body media-middle text-nowrap">
...
<script>
	...
	export default {
		components: {
			LayoutHeaderEmployee,
			LayoutSidebarReports,
		},
		mounted() {
			// Date Time Picker
