                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6 m-b-20">
                                            <img src="../assets/logo2.png" class="inv-logo" alt="">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="d-none d-sm-table-cell">Lorem ipsum dolor sit amet,
                                    ...
                                    <div>
                                                    ...
                                                    <div class="table-responsive no-border">
                                                        <table class="table mb-0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th>Tax: <span class="text-regular">(25%)</span>
                                                                    </th>
                                        ...
                                        <div class="invoice-info">
                                            ...
                                            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                elit. Vivamus sed dictum ligula, cursus blandit risus. Maecenas eget
                                                metus non tellus dignissim aliquam ut a ex. Maecenas sed vehicula dui,
                                                ac suscipit lacus. Sed finibus leo vitae lorem interdum, eu scelerisque
                                                tellus fermentum. Curabitur sit amet lacinia lorem. Nullam finibus
                                                pellentesque libero, eu finibus sapien interdum vel</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
