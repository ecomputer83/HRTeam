                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-right ml-auto">
                                ...
                                <div class="view-icons">
                                    <router-link to="/projects" class="grid-view btn btn-link"><i class="fa fa-th"></i>
                                    </router-link>
                                    <router-link to="/projectlist" class="list-view btn btn-link active"><i
                                                ...
                                                <ul class="team-members">
                                                    <li>
                                                        <a href="#" data-toggle="tooltip" title="Jeffery Lalor"><img
                                                                alt="" src="../assets/profiles/avatar-16.jpg"></a>
                                                    </li>
                                                </ul>
                                            </td>
                                            <td>
                                                <ul class="team-members text-nowrap">
                                                    ...
                                                    <li>
                                                        <a href="#" title="Richard Miles" data-toggle="tooltip"><img
                                                                alt="" src="../assets/profiles/avatar-09.jpg"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" title="John Smith" data-toggle="tooltip"><img alt=""
                                                                src="../assets/profiles/avatar-10.jpg"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" title="Mike Litorus" data-toggle="tooltip"><img
                                                                alt="" src="../assets/profiles/avatar-05.jpg"></a>
                                                    </li>
