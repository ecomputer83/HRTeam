                                ...
                                <table class="table table-striped custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>
                                                <router-link to="/jobdetails">Web Developer</router-link>
                                            </td>
                                            <td>Development</td>
                                            <td>3 Mar 2019</td>
                                            <td>31 May 2019</td>
                                            <td class="text-center">
                                                <div class="dropdown action-label">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="#"><i
                                                                class="fa fa-dot-circle-o text-success"></i> Part
                                                            Time</a>
                                                        <a class="dropdown-item" href="#"><i
                                            ...
                                            <td>
                                                <router-link to="/jobapplicants" class="btn btn-sm btn-primary">3
                                                    Candidates
                                                </router-link>
                                            </td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td>
                                                <router-link to="/jobdetails">Web Designer</router-link>
                                            </td>
                                            <td>Designing</td>
                                            <td>3 Mar 2019</td>
                                            <td>31 May 2019</td>
                                            ...
                                            <td>
                                                <router-link to="/jobapplicants" class="btn btn-sm btn-primary">2
                                                    Candidates
                                                </router-link>
                                            </td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td>
                                                <router-link to="/jobdetails">Android Developer</router-link>
                                            </td>
                                            <td>Android</td>
                                            <td>3 Mar 2019</td>
                                            <td>31 May 2019</td>
                                            ...
                                            <td>
                                                <router-link to="/jobapplicants" class="btn btn-sm btn-primary">1
                                                    Candidates
                                                </router-link>
                                            </td>
                                            <td class="text-right">
