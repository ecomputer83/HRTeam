                ...
                <div class="content container-fluid">
                    ...
                    <div class="row board-view-header">
                            ...
                            <div class="pro-teams">
                                ...
                                <div class="pro-team-members">
                                    ...
                                    <div class="avatar-group">
                                        ...
                                        <div class="avatar">
                                            <a href="" class="avatar-title rounded-circle border border-white"
                                                data-toggle="modal" data-target="#assign_user"><i
                                                    class="fa fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-8 text-right">
                            <a href="#" class="btn btn-white float-right ml-2" data-toggle="modal"
                                data-target="#add_task_board"><i class="fa fa-plus"></i> Create List</a>
                            <router-link to="/projectview" class="btn btn-white float-right" title="View Board"><i
                                    class="fa fa-link"></i></router-link>
                        </div>
                                ...
                                <div class="kanban-list kanban-danger">
                                    ...
                                    <div class="kanban-wrap">
                                        <div class="card panel">
                                            <div class="kanban-box">
                                                <div class="task-board-header">
                                                    <!-- <span class="status-title"><router-link to=""></router-link></span> -->
                                                    <span class="status-title"><a>Website redesign</a></span>
                                                ...
                                                <div class="task-board-body">
                                                    ...
                                                    <div class="kanban-footer">
                                                        ...
                                                        <span class="task-users">
                                                            <img src="../assets/profiles/avatar-12.jpg"
                                        ...
                                        <div class="card panel">
                                            <div class="kanban-box">
                                                <div class="task-board-header">
                                                    <span class="status-title"><a>Make a wireframe</a></span>
                                                    <div class="dropdown kanban-task-action">
                                                        <a href="" data-toggle="dropdown">
                                                            <i class="fa fa-angle-down"></i>
                                                        </a>
                                    ...
                                    <div class="add-new-task">
                                        <a href="javascript:void(0);" data-toggle="modal"
                                            data-target="#add_task_modal">Add New Task</a>
                                    </div>
                                </div>
                                    ...
                                    <ul class="chat-user-list">
                                            ...
                                            <a href="#">
                                                <div class="media">
                                                    <span class="avatar"><img alt=""
                                                            src="../assets/profiles/avatar-09.jpg"></span>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="media">
                                                    <span class="avatar"><img alt=""
                                                            src="../assets/profiles/avatar-10.jpg"></span>
                                                    <div class="media-body align-self-center text-nowrap">
