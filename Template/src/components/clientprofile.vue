                                    ...
                                    <div class="profile-view">
                                        <div class="profile-img-wrap">
                                            <div class="profile-img">
                                                <a href="">
                                                    <img src="../assets/profiles/avatar-19.jpg" alt="">
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-7">
                                                    <ul class="personal-info">
                                                        ...
                                                        <li>
                                                            ...
                                                            <span class="text"><a
                                                                    href="">barrycuda@example.com</a></span>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <span class="text">5754 Airport Rd, Coosada, AL,
                                                                36020</span>
                                                        </li>
                                                        <li>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <small class="block text-ellipsis m-b-15">
                                                        <span class="text-xs">1</span> <span class="text-muted">open
                                                            tasks, </span>
                                                            ...
                                                            <li>
                                                                <a href="#" data-toggle="tooltip"
                                                                    title="Jeffery Lalor"><img alt=""
                                                                        src="../assets/profiles/avatar-16.jpg"></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="project-members m-b-15">
                                                            ...
                                                            <li>
                                                                <a href="#" data-toggle="tooltip"
                                                                    title="Richard Miles"><img alt=""
                                                                        src="../assets/profiles/avatar-09.jpg"></a></a>
                                                            </li>
                                                            <li>
                                                                <a href="#" data-toggle="tooltip"
                                                                    title="John Smith"><img alt=""
                                                                        src="../assets/profiles/avatar-10.jpg"></a>
                                                            </li>
                                                            <li>
                                                                <a href="#" data-toggle="tooltip"
                                                                    title="Mike Litorus"><img alt=""
                                                                        src="../assets/profiles/avatar-05.jpg"></a>
                                                            </li>
                                                            <li class="dropdown avatar-dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <div class="avatar-group">
                                                                        ...
                                                                        <a class="avatar avatar-xs" href="#">
                                                                            <img alt=""
                                                                                src="../assets/profiles/avatar-10.jpg">
                                                                        </a>
                                                                        <a class="avatar avatar-xs" href="#">
                                                                            <img alt=""
                                                                        ...
                                                                        <a class="avatar avatar-xs" href="#">
                                                                            <img alt=""
                                                                                src="../assets/profiles/avatar-11.jpg">
                                                                        </a>
                                                                        <a class="avatar avatar-xs" href="#">
                                                                            <img alt=""
                                                                                src="../assets/profiles/avatar-12.jpg">
                                                                        </a>
                                                                        <a class="avatar avatar-xs" href="#">
                                                                            <img alt=""
                                                                                src="../assets/profiles/avatar-13.jpg">
                                                                        </a>
                                                                        <a class="avatar avatar-xs" href="#">
                                                                            <img alt=""
                                                                        ...
                                                                        <a class="avatar avatar-xs" href="#">
                                                                            <img alt=""
                                                                                src="../assets/profiles/avatar-16.jpg">
                                                                        </a>
                                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <small class="block text-ellipsis m-b-15">
                                                        <span class="text-xs">2</span> <span class="text-muted">open
                                                            tasks, </span>
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <small class="block text-ellipsis m-b-15">
                                                        <span class="text-xs">3</span> <span class="text-muted">open
                                                            tasks, </span>
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="project-title">
                                                        <router-link to="/projectview">Hospital Administration
                                                        </router-link>
                                                    </h4>
                                                    <small class="block text-ellipsis m-b-15">
                                                        <span class="text-xs">12</span> <span class="text-muted">open
                                                            tasks, </span>
                                                    ...
                                                    <div class="task-list-container">
                                                            ...
                                                            <ul id="task-list">
                                                                ...
                                                                <li class="task">
                                                                    <div class="task-container">
                                                                        ...
                                                                        <span class="task-label"
                                                                            contenteditable="true">Appointment booking
                                                                ...
                                                                <li class="task">
                                                                    <div class="task-container">
                                                                        ...
                                                                        <span class="task-label"
                                                                            contenteditable="true">Patient and Doctor
                                                        ...
                                                        <div class="task-list-footer">
                                                            <div class="new-task-wrapper">
                                                                ...
                                                                <span class="error-message hidden">You need to enter a
                                                                    task first</span>
