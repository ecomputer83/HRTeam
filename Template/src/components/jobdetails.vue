                        ...
                        <div class="col-md-8">
                            <div class="job-info job-widget">
                                ...
                                <ul class="job-post-det">
                                    <li><i class="fa fa-calendar"></i> Post Date: <span class="text-blue">Feb 18,
                                            2019</span></li>
                                    <li><i class="fa fa-calendar"></i> Last Date: <span class="text-blue">May 31,
                                            2019</span></li>
                            ...
                            <div class="job-det-info job-widget">
                                ...
                                <div class="info-list">
                                    <p class="text-truncate"> 818-978-7102
                                        <br>
                                        <router-link to="mailto:danielporter@example.com"
                                            title="danielporter@example.com">danielporter@example.com</router-link>
                                        <br>
                                        <router-link to="https://www.example.com" target="_blank"
                                            title="https://www.example.com">https://www.example.com</router-link>
                                    </p>
                                </div>
