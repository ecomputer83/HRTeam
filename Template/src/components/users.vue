                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <router-link to="/profile" class="avatar"><img
                                                            src="../assets/profiles/avatar-21.jpg" alt=""></router-link>
                                                    <router-link to="/profile">Daniel Porter <span>Admin</span>
                                                    </router-link>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <router-link to="/profile">Richard Miles <span>Admin</span>
                                                    </router-link>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <router-link to="/profile">Barry Cuda <span>Global
                                                            Technologies</span>
                                                    </router-link>
                                                </h2>
                                            </td>
