                                                ...
                                                <ul class="nav float-right custom-menu">
                                                    <li class="nav-item dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="javascript:void(0)">Menu
                                                                1</a>
                                                            <a class="dropdown-item" href="javascript:void(0)">Menu
                                                                2</a>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="contact-cat col-sm-4 col-lg-3">
                                                        <a href="#" class="btn btn-primary btn-block"
                                                            data-toggle="modal" data-target="#add_contact"><i
                                                        ...
                                                        <ul class="contact-list">
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">John
                                                                            Doe</span>
                                                                        ...
                                                                        <li class="dropdown dropdown-action">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <a class="dropdown-item"
                                                                                    ...
                                                                                    data-toggle="modal"
                                                                                    data-target="#edit_contact">Edit</a>
                                                                                <a class="dropdown-item"
                                                                                    href="javascript:void(0)"
                                                                                    data-toggle="modal"
                                                                                    data-target="#delete_contact">Delete</a>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">Richard
                                                                            Miles</span>
                                                                        <span class="contact-date">Web Developer</span>
                                                                    </div>
                                                                    <ul class="contact-action">
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">John
                                                                            Smith</span>
                                                                        <span class="contact-date">Android
                                                                            Developer</span>
                                                                    </div>
                                                                    <ul class="contact-action">
                                                                        <li class="dropdown dropdown-action">
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">Mike
                                                                            Litorus</span>
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">Wilmer
                                                                            Deluna</span>
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">Jeffrey
                                                                            Warden</span>
                                                                        <span class="contact-date">Web Developer</span>
                                                                    </div>
                                                                    <ul class="contact-action">
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span
                                                                            class="contact-name text-ellipsis">Bernardo
                                                                            Galaviz</span>
                                                                        <span class="contact-date">Web Developer</span>
                                                                    </div>
                                                                    <ul class="contact-action">
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">Lesley
                                                                            Grauer</span>
                                                                        <span class="contact-date">Team Leader</span>
                                                                    </div>
                                                                    <ul class="contact-action">
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">Jeffery
                                                                            Lalor</span>
                                                                        <span class="contact-date">Team Leader</span>
                                                                    </div>
                                                                    <ul class="contact-action">
                                                            ...
                                                            <li>
                                                                <div class="contact-cont">
                                                                    ...
                                                                    <div class="contact-info">
                                                                        <span class="contact-name text-ellipsis">Loren
                                                                            Gatlin</span>
                                                                        <span class="contact-date">Android
                                                                            Developer</span>
                                                                    </div>
