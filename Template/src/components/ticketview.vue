                                                        ...
                                                        <div class="chat-content">
                                                            ...
                                                            <ul class="attach-list">
                                                                <li class="img-file">
                                                                    ...
                                                                    <div class="task-attach-img"><img src="../assets/user.jpg" alt=""></div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                        ...
                        <div class="chat-footer">
                            <div class="message-bar">
                                <div class="message-inner">
                                    <a class="link attach-icon" href="#"><img src="../assets/attachment.png" alt=""></a>
                            ...
                            <div class="project-members task-followers">
                                ...
                                <a href="#" data-toggle="tooltip" title="Wilmer Deluna" class="avatar">
                                    <img src="../assets/profiles/avatar-11.jpg" alt="">
                                </a>
