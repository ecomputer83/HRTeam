                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto float-right ml-auto">
                                <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_plan"><i
                    ...
                    <div class="row">
                        <div class="col-lg-10 mx-auto">
                            ...
                            <div class="row justify-content-center mb-4">
                                <div class="col-auto">
                                    <nav class="nav btn-group">
                                        <a href="#monthly" class="btn btn-outline-secondary active show"
                                            data-toggle="tab">Monthly Plan</a>
                                        <a href="#annual" class="btn btn-outline-secondary" data-toggle="tab">Annual
                                            Plan</a>
                                    </nav>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="card pricing-box">
                                                <div class="card-body d-flex flex-column">
                                                    ...
                                                    <a href="#" class="btn btn-lg btn-secondary mt-auto"
                                                        ...
                                                        <table class="table table-hover table-center mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>Free</td>
                                                                    <td>
                                                                        <router-link to="/subscribedcompanies"
                                                                            class="btn btn-info btn-sm">30 Users
                                                                        </router-link>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <router-link to="/subscribedcompanies"
                                                                            class="btn btn-info btn-sm">97 Users
                                                                        </router-link>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <router-link to="/subscribedcompanies"
                                                                            class="btn btn-info btn-sm">125 Users
                                                                        </router-link>
                                                        ...
                                                        <table class="table table-hover table-center mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <router-link to="/subscribedcompanies"
                                                                            class="btn btn-info btn-sm">62 Users
                                                                        </router-link>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <router-link to="/subscribedcompanies"
                                                                            class="btn btn-info btn-sm">157 Users
                                                                        </router-link>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <router-link to="/subscribedcompanies"
                                                                            class="btn btn-info btn-sm">241 Users
                                                                        </router-link>
                            ...
                            <!-- Add Plan Modal -->
                            <div class="modal custom-modal fade" id="add_plan" tabindex="-1" role="dialog"
                                aria-hidden="true">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Free Trial"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Plan Name</label>
                                                            <input type="text" placeholder="Free Trial"
                                                                class="form-control" value="Free Trial">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
