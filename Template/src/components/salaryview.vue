                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><strong>Basic Salary</strong> <span
                                                                    class="float-right">$6500</span></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div>
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><strong>ESI</strong> <span class="float-right">$0</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Loan</strong> <span
                                                                    class="float-right">$300</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><strong>Total Deductions</strong> <span
                                                                    class="float-right"><strong>$59698</strong></span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="col-sm-12">
                                            <p><strong>Net Salary: $59698</strong> (Fifty nine thousand six hundred and
                                                ninety eight only.)</p>
                                        </div>
                                    </div>
                                </div>
