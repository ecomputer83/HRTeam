                                ...
                                <div class="card-body">
                                    <article class="post">
                                        ...
                                        <ul class="meta">
                                            ...
                                            <li><span>Category:</span> <a href="#">Category 1</a>, <a href="#">Category
                                                    2</a></li>
                                                        ...
                                                        <div class="comment-details">
                                                            <div class="author-name">
                                                                <a class="url" href="#">John Doe</a> <span
                                                                    class="commentmetadata">October 25, 2016 at 01:10
                                                                    pm</span>
                                                            </div>
                                                            <div class="comment-body">
                                                                <p>Integer id dolor libero. Cras in turpis nulla.
                                                            ...
                                                            <div class="reply"><a href="#" class="comment-reply-link"
                                                                    rel="nofollow"><i class="fa fa-reply"></i> Reply</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <ul class="children">
                                                        <li>
                                                            <div class="comment">
                                                                ...
                                                                <div class="comment-details">
                                                                    <div class="author-name">
                                                                        <a href="#" class="comment-reply-link"></a><a
                                                                            class="url" href="#">Astin Robert</a> <span
                                                                            class="commentmetadata">October 25, 2016 at
                                                                            01:10 pm</span>
                                                                    </div>
                                                                    <div class="comment-body">
                                                                        <p>Mauris hendrerit consequat quam, sit amet
                                            ...
                                            <div class="comment-reply">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="submit-section">
                                                        <button type="submit" class="btn btn-primary submit-btn">Post
                                                            Comment</button>
                                                    </div>
                                                </form>
                                            </div>
