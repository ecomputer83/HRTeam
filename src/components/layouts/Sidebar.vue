<template>
  ...
  <div id="sidebar-menu" class="sidebar-menu">
    <ul>
      ...
      <li>
        <router-link to="/index" class="admin"><i class="la la-dashboard"></i> <span> Dashboard</span></router-link>
      </li>
...
"></i> <span>Job Profile</span></router-link>
      ...
      <li class="policies">
        <router-link to="/applications"><i class="la la-briefcase"></i> <span>Applications</span></router-link>
      </li>
      <li class="policies">
        <router-link to="/applicants"><i class="la la-user-plus"></i> <span>Applicants</span></router-link>
      </li>
      <li class="policies">
        <router-link to="/talent-search"><i class="la la-user-secret"></i> <span>Talent Search</span></router-link>
      </li>
      <li class="policies">
