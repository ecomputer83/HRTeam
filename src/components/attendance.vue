                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <router-link to="/profile" class="avatar avatar-xs"><img alt=""
                                                            src="../assets/profiles/avatar-09.jpg"></router-link>
                                                    <router-link to="/profile">Ricahrd Miles</router-link>
                                                </h2>
                                            </td>
                                            <td><a href="javascript:void(0);" data-toggle="modal"
                                                    data-target="#attendance_info"><i
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <router-link to="/profile">Bernado Galaviz</router-link>
                                                </h2>
                                            </td>
                                            <td><a href="javascript:void(0);" data-toggle="modal"
                                                    data-target="#attendance_info"><i
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <router-link to="/profile" class="avatar avatar-xs"><img alt=""
                                                            src="../assets/profiles/avatar-01.jpg"></router-link>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <router-link to="/profile" class="avatar avatar-xs"><img alt=""
                                                            src="../assets/profiles/avatar-16.jpg"></router-link>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <router-link to="/profile" class="avatar avatar-xs"><img alt=""
                                                            src="../assets/profiles/avatar-04.jpg"></router-link>
