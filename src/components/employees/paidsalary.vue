                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">Paid Salary</h3>
                                <ul class="breadcrumb">
                            ...
                            <div class="table-responsive">
                                ...
                                >
                                    <template v-slot:[`item.actions`]="{ item }">                    
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a
                                                    class="dropdown-item"
                                                    @click="setEditPaidSalary(item)"
                                                ><i class="fa fa-pencil m-r-5"></i> Edit</a
                                                >
                                                <a
                                                    class="dropdown-item"
                                                    @click="setDeletePaidSalary(item)"
                                    ...
                                    <template v-slot:[`item.payslip`]="{ item }"> 
                                        <router-link class="btn btn-sm btn-primary" :to="{name: 'salaryview', params: {id: item.id}}">
                                            Generate Slip
                                        </router-link>  
                                    </template>
                                </v-data-table>    
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                headers: [
                    { text: 'Salary Date', value: 'salaryDate' },
                    { text: 'Salary Amount', value: 'netSalary' },
        ...
        methods: {
            generateSlip () {
                return (
                    <router-link class="btn btn-sm btn-primary" to="/salaryview">
                        Generate Slip
                    </router-link>
                )
            },
