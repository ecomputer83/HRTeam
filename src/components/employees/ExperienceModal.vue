              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div
                      v-if="submitted && !$v.companyName.required"
                  ...
                  <div class="col-md-6">
                    ...
                    <div
                      v-if="submitted && !$v.position.required"
                      class="invalid-feedback"
                    >
...
export default {
  ...
  methods: {
    postExperience() {
      ...
      if (this.model.id) {
        employeeService
          ...
          .then(
            (model) => {
              this.message = "Experience update successfully!";
        ...
        employeeService
          ...
          .then(
            (model) => {
              this.message = "Experience create successfully!";
              employeeService.getEmployeeDetail(this.employeeId).then(
                (model) => {
                  this.employee = model;
                  if (!this.employee.employeePension) {
    ...
    removeExperience() {
      if (this.model.id) {
        employeeService.removeEmployeeExperience(this.model.id).then(
          (id) => {
            (this.companyName = ""),
              (this.position = ""),
              (this.startYear = ""),
