												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group form-focus focused">
															<input type="text"  v-model.trim="$v.institute.$model" class="form-control floating" style="height: 55px !important;">
															<label class="focus-label">Institution</label>
														</div>
                                                        <div v-if="submitted && !$v.institute.required" class="invalid-feedback">Institution is required</div>
													</div>
													<div class="col-md-6">
														<div class="form-group form-focus focused">
															<input type="text"  v-model.trim="$v.discipline.$model" class="form-control floating" style="height: 55px !important;">
															<label class="focus-label">Discipline</label>
														</div>
                                                        <div v-if="submitted && !$v.discipline.required" class="invalid-feedback">Discipline is required</div>
													</div>
													<div class="col-md-6">
														<div class="form-group form-focus focused">
															<div class="cal-icon">
                                                        ...
                                                        <div v-if="submitted && !$v.startYear.required" class="invalid-feedback">Starting Date is required</div>
													</div>
													<div class="col-md-6">
														<div class="form-group form-focus focused">
															<div class="cal-icon">
                                                        ...
                                                        <div v-if="submitted && !$v.endYear.required" class="invalid-feedback">Complete Date is required</div>
													</div>
												</div>
											</div>
										</div>
...
import { employeeService } from '@/services/employeeService';
  export default {
    ...
    methods: {
        ...
        removeEducation() {
            if(this.model.id){
              employeeService.removeEmployeeEducation(this.model.id)
              .then(
                  id => {
                      this.companyName = '',
                      this.position = '',
