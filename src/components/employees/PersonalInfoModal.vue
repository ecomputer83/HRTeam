        ...
        <form @submit.prevent="putPersonalInfo">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input
                  type="text"
                  class="form-control"
                  v-model="passportIdentificationNumber"
                />
              </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <div
                v-if="submitted && !$v.nationality.required"
                class="invalid-feedback"
              >
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input
                  class="form-control"
                  type="text"
                  v-model.trim="$v.religion.$model"
                />
              </div>
              <div
                v-if="submitted && !$v.religion.required"
                class="invalid-feedback"
              >
            ...
            <div class="col-md-6">
              ...
              <div
                v-if="submitted && !$v.maritalStatus.required"
                class="invalid-feedback"
              >
...
export default {
  ...
  methods: {
    putPersonalInfo() {
      ...
      employeeService.updateEmployeePersonalInfo(
        this.model.id,
        this.passportIdentificationNumber,
        this.nationality,
        this.phone,
        this.religion,
        this.maritalStatus
