            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-6 text-center">
                  <div class="card  v-graph">
                    <div class="card-body">
                      <h3 class="card-title">Total Revenue</h3>
                      <div id="bar-chart" style="width:auto !important"></div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 text-center">
                  <div class="card  v-graph">
                    <div class="card-body">
                      ...
                      <div id="line-chart" style="width:auto !important"></div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="leave-info-box">
                    <div class="media align-items-center">
                      <router-link to="/profile" class="avatar"><img alt="" src="../assets/user.jpg"></router-link>
            ...
            <div class="col-md-6 d-flex">
              <div class="card card-table flex-fill">
                ...
                <div class="card-footer">
                  <router-link to="/invoiceview">View all invoices</router-link>
                </div>
              </div>
            </div>
            <div class="col-md-6 d-flex">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <h2 class="table-avatar">
                              <a href="#" class="avatar"><img alt="" src="../assets/profiles/avatar-19.jpg"></a>
                              <router-link to="/clientprofile">Barry Cuda <span>CEO</span></router-link>
                            </h2>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h2 class="table-avatar">
                              <a href="#" class="avatar"><img alt="" src="../assets/profiles/avatar-19.jpg"></a>
                              <router-link to="/clientprofile">Tressa Wexler <span>Manager</span></router-link>
                            </h2>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h2 class="table-avatar">
                              ...
                              <router-link to="/clientprofile">Ruby Bartlett <span>CEO</span></router-link>
                            </h2>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h2 class="table-avatar">
                              ...
                              <router-link to="/clientprofile">Misty Tison <span>CEO</span></router-link>
                            </h2>
                          </td>
                        ...
                        <tr>
                          <td>
                            <h2 class="table-avatar">
                              ...
                              <router-link to="/clientprofile">Daniel Deacon <span>CEO</span></router-link>
                            </h2>
                          </td>
                    ...
                    <table class="table custom-table mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <h2>
                              <router-link to="/projectview">Digital Marketplace</router-link>
                            </h2>
                            <small class="block text-ellipsis">
