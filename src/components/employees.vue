						...
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								...
								<div class="view-icons">
									<router-link to="/employees" class="grid-view btn btn-link active"><i
											class="fa fa-th"></i></router-link>
									<router-link to="/employeeslist" class="list-view btn btn-link"><i
					...
					<div class="row staff-grid-row">
							...
							<div class="profile-widget">
								<div class="profile-img">
									<router-link to="/profile" class="avatar"><img
											src="../assets/profiles/avatar-02.jpg" alt=""></router-link>
								</div>
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 mb-0 text-ellipsis">
									<router-link to="/profile">Jeffrey Lalor</router-link>
								</h4>
								<div class="small text-muted">Team Leader</div>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									<router-link to="/profile" class="avatar"><img
											src="../assets/profiles/avatar-03.jpg" alt=""></router-link>
								</div>
								<div class="dropdown profile-action">
									<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown"
										aria-expanded="false"><i class="material-icons">more_vert</i></a>
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									<router-link to="/profile" class="avatar"><img
											src="../assets/profiles/avatar-08.jpg" alt=""></router-link>
								</div>
								<div class="dropdown profile-action">
									<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown"
										aria-expanded="false"><i class="material-icons">more_vert</i></a>
								...
								<h4 class="user-name m-t-10 mb-0 text-ellipsis">
									<router-link to="/profile">Catherine Manseau</router-link>
								</h4>
								<div class="small text-muted">Android Developer</div>
							</div>
						</div>
